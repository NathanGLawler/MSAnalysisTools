...
```{r}
metConfig <- read.csv2("https://docs.google.com/spreadsheets/d/e/2PACX-1vSugXXHxtwZIijb9r41-vUln-aLvhiRsncr2DwSvSjF3tr99pLTQCJlge3UB2RwuCeVJikUmE6G3HCZ/pub?output=csv", header = TRUE, sep = ",")

fileConfig <- read.csv2("https://docs.google.com/spreadsheets/d/e/2PACX-1vSugXXHxtwZIijb9r41-vUln-aLvhiRsncr2DwSvSjF3tr99pLTQCJlge3UB2RwuCeVJikUmE6G3HCZ/pub?gid=631312894&single=true&output=csv", header = TRUE, sep = ",")
...
```
#Create a PDF of the plots
```{r}

pdf("plotsLTRAA.pdf")
for (i in 1:length(plotData_LTRQ)) {
  print(plotData_LTRQ[[i]])
}
dev.off()
