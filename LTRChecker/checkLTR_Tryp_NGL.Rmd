...
```{r}
test <- read_sheet("https://docs.google.com/spreadsheets/d/1qQ9LwV1vutixX4xTvq97DLLUlw67unwh/edit?usp=sharing&ouid=105329809158885989717&rtpof=true&sd=true")
```
...
```{r}
#Read config file
metConfig <- readxl::read_excel("./config/configFile.xlsx", sheet="metabolitesTryp")
fileConfig <- readxl::read_excel("./config/configFile.xlsx", sheet="dataFilesTryp")
...
# for(fileName in dataFiles){
  ...
  sampleID <- sampleType@obsDescr[[1]]$Name
